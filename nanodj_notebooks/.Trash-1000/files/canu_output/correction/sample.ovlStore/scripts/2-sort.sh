...
#  This script should be executed from correction/sample.ovlStore.BUILDING/, but the binary needs
...
if [ -e ./sample.ovlStore.BUILDING/$jobname.info -a ! -e ./sample.ovlStore.BUILDING/$jobname.started ] ; then
  echo "Sorting job finished; info file './sample.ovlStore.BUILDING/$jobname.info' exists."
  exit
fi
#
#  Sort!
